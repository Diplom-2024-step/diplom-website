...
const ReviewCard = ({ review }: { review: GetReviewDto }) => {
  ...
  return (
    <>
      <Card
        isHoverable
        isPressable
        className="p-4 bg-customAqua rounded-lg h-80"
        onClick={() => onOpen()}
      >
        {/* Фото пользователя */}
        <div className="flex items-center h-[15%]">
          <Image
            ...
            height={48}
            src={
              getIconAccordingToIconNumber(review.user.iconNumber.toString())
                .src
            }
            width={48}
          />
            ...
            <>
              <ModalHeader className="flex  gap-1">
                ...
                <Image
                  ...
                  height={64}
                  src={getIconAccordingToIconNumber(
                    review.user.iconNumber.toString()
                  )}
                  width={64}
                />
                <div className="ml-4">
