        ...
        <div className="flex flex-col md:flex-row w-full md:w-[1000px] md:h-auto bg-white rounded-[20px] shadow-lg p-4 md:p-4 mt-6">
                ...
                <div className="mt-10 mb-10 justify-center w-full md:w-2/5 p-5 flex flex-col">
                    ...
                    <p  
                        ...
                        className="text-center text-[#0F171B] text-[14px]">"Створіть новий надійний пароль для вашого<br/>облікового запису."
                    </p>
                    ...
                    <Input
                        ...
                        errorMessage={confirmPasswordError ? 'Паролі не збігаються. Будь ласка, перевірте та повторно введіть.' : ''}
                    />
                    </div>
                    <Spacer className="my-6"/>
